        ...
        <div className="container relative pb-10">
          <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-6">
            <h1 className="text-center text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1]">
              An innovative, cloud-based platform for the food industry
            </h1>
            <span className="max-w-[750px] text-center text-lg font-light text-foreground">
              deep.food leverages real-time data analytics and machine learning to optimize inventory management, reduce food waste, and boost sustainability for restaurants, supermarkets, and food manufacturers.
            </span>
